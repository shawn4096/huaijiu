...
//              "，金铙乃本寺达摩祖师传下之宝物，老衲可不敢拿来随意送人。";
        ...
        if ( present("fumo nao", this_object())){
             ...
             if(clonep(whip)){
                ...
                if (!(whip = present("changbian", this_object()))) whip = unew(BINGQI_D("changbian")); 
                whip->move(this_object());
                command("wield bian"); 
             }
