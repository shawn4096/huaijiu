...
/*      if( (!me->query("class") || me->query("class") != "bonze") && myfam["family_name"] == "峨嵋派"){
...
int accept_object(object who, object ob)
{
        ...
        message_vision(HBGRN"孤鸿子向$N指导了一些武功的技巧。\n"NOR,who);
        who->set_temp("emei/jianjue",1);
        who->add("combat_exp",100+random(who->query_skill("linji-zhuang",1)));
        who->improve_skill("force",who->query_skill("force")*5);
	call_out("dest", 1, ob);
        set("jian",1);
