...
mapping query_action(object me, object weapon)
{
        ...
        if (level > 100 && force > 150 && neili > 500 
        	...
        	switch(j){
			case 6: msgs ="$N一拳击出，拳风中竟带有刚柔三种不同的劲力，分击$n的全身上下三十六道要穴。\n" NOR;break;
		        case 5: msgs ="$N紧跟着第二拳又出，出手迅如闪电，快的看不清来路，晃得一晃，却直奔$n前胸。\n" NOR;break;
		        case 4: msgs ="$N一声狂啸，双目赤红，拳路大开大阖，每一拳击出如诸神震怒，石破天惊。\n" ;break;
		        case 3: msgs ="$N大喝一声，双拳连环虚击，风声未起，拳上暗劲已如怒潮倒灌，海啸逆卷，袭向$n。\n";break;
		        case 2: msgs ="$N拳出如风，砰砰接连七拳，都打在$n身上，但却似不关痛痒，便如清风拂体，柔丝抚身。\n";break;
		        case 1: msgs ="$N双目微阖，步法飘忽，轻飘飘击出数拳，$n蓦地察觉微风拂体，拳上阴劲已袭向后心。\n";break;
		        default:msgs =HIR"$N双目紧闭深运内力，然后猛的大喝了一声，以七种无比之劲力击向$n的全身。\n"NOR; break;
		}
