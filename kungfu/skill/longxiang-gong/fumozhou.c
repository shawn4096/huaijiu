...
void remove_effect(object me)
{
    if(me && me->query_temp("mz_lx")){
      me->add_temp("apply/strength", -me->query_skill("longxiang-gong", 1)/6);
      me->add_temp("apply/dexerity", -me->query_skill("longxiang-gong", 1)/6);
...
void check_fight(object me)
{
    ...
    if (me->query_skill_mapped("force"!="longxiang-gong") ||
        !me->is_fighting() || me->query("neili") < 10
...
int exert(object me)
{
      ...
      i = me->query_skill("longxiang-gong", 1)/6;
      z = me->query_skill("lamaism")/2;
      me->add("neili", -500);
