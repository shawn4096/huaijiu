...
int perform(object me,object target)
{
	...
	if(me->query_skill_mapped("parry") != "murong-jianfa" && me->query_skill_mapped("parry") != "douzhuan-xingyi")
...
void check_fight(object me, int i, int j, int d)
{
	...
	if(me->query_skill_mapped("sword") != "murong-jianfa") {
		...
		remove_effect(me, j, d);
	} else if(me->query_skill_mapped("parry") != "murong-jianfa" && me->query_skill_mapped("parry") != "douzhuan-xingyi"){
