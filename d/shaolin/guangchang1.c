...
void create()
{
    set("short", "¹ã³¡");
    set("long", @LONG
ÕâÀïÊÇÉÙÁÖËÂÇ°µÄ¹ã³¡£¬Õû¸ö¹ã³¡ÓÉ´ó¿éµÄÇàÊ¯ÆÌ³É£¬¼«ÎªÆ½Ì¹¡£µ«Òò
Äê´ú¾ÃÔ¶£¬¶¼ÓĞĞ©ÆÆËğ¡£´Ô´ÔĞ¡²İ´ÓÊ¯°åµÄ·ìÏ¶ÖĞ³¤ÁË³öÀ´¡£¹ã³¡ÖÜÎ§¶¼ÊÇ
ÃÜÃÜµÄËÉÊ÷ÁÖ£¬ËÄ½ÇÉÏ¸÷·ÅÁË¼¸¿éÊ¯±®£¬×Ö¼£¶¼ÉõÎªÄ£ºı¡£ÕıÇ°·½»ÆÇ½±ÌÍß
£¬·ÉéÜÇÌéİ£¬ÕıÖĞÒ»µÀ¶şÕÉÀ´¿í£¬ÈıÕÉÀ´¸ßµÄÖìºìÉ¼Ä¾°üÍ­´óÃÅ(gate)¡£ÉÏ
·½Ò»¿é´óØÒ£¬Áú·É·ïÎèµØÊé×Å¡º[1;33mÉÙÁÖËÂ[0;37;0m¡»Èı¸ö´ó×Ö¡£ËÂÇ°ÈıÈıÁ½Á½µÄÕ¾×Å¼¸
¸öÉ®ÈË¡£
LONG
    );
...
/* TODO
 ´Ë´¦¸ÄÎª£º(knock gate) ÇÃÃÅºóÒ»É®ÈËÓ¦Éù´ò¿ª´óÃÅ£º
¡°Ö¨¡±µÄÒ»Éù£¬´óÃÅ´òÁË¿ªÀ´£¬Ò»Î»×³ÄêÉ®ÈËÉÏÉÏÏÂÏÂ´òÁ¿ÁËÄã
£¨Ëû£¬Ëı£¬ÈËÃû£© Ò»»á£¬
£¨ÈçÎª±¾ËÂÉ®ÈË£¬ÇÒÎŞ×ï¹ı£¬ÕıÉñÌá¸ß»òÎŞÔö¼õ£©²àÉíÈÃ¿ª£¬ËµµÀ£ºÊ¦ĞÖĞÁ¿àÁË£¬Çë½ø¡£
£¨ÈçÎª±¾ËÂÉ®ÈË£¬ÕıÉñ½µµÍ»òÓĞ¸ºÉñ£©³ÁÏÂÁ³À´£¬ËµµÀ£º½äÂÉÔºÖ÷³ÖĞşÍ´´óÊ¦ÇëÊ¦ĞÖ»ğ
¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡ËÙÈ¥½äÂÉÔº³ÂÊö´ËĞĞ¹ı·¸¡£
¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡£¨Ö±½ÓËÍ½»½äÂÉÔº´¦ÖÎ²éÎÊºó£¬´òÈëÉ®¼à¹ØÑº£©¡£
£¨Èç·Ç±¾ËÂÉ®ÈË£¬ÄĞĞÔ£¬ÓĞÕıÉñ£©ËµµÀ£ºÕâÎ»Ê©Ö÷Çë»Ø°Õ£¬±¾ËÂ²»½Ó´ıË×ÈË¡£
£¨Èç·Ç±¾ËÂÉ®ÈË£¬Å®ĞÔ£¬ÓĞÕıÉñ£©ËµµÀ£ºÕâÎ»Å®Ê©Ö÷»¹ÊÇÇë»Ø°Õ£¬±¾ËÂ´Ó²»½Ó´ıÅ®¿Í¡£
£¨Èç·Ç±¾ËÂÉ®ÈË£¬ÎŞÂÛÄĞÅ®£¬ÓĞ¸ºÉñ£©Á¢Ê±´ÓÉíÅÏÖ¿³öÒ»°ÑÑ©ÁÁµÄ½äµ¶À´£¬°ÑÃ÷»Î»ÎµÄ
¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡µ¶¼â¶Ô×¼ÄãµÄĞØ¿Ú£¬ºáÃ¼Å­Ä¿µØËµµÀ£ºÄãµÈĞ°Ä§
¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡ÍâµÀ£¬»¹²»¸øÎÒ¹ö¿ª£¡ÒÔºóÔÙ¸Ò×ß½üÉÙÁÖÒ»²½£¬
¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡¡ÎÒÁ¢Ê±¾ÍÕ¶¶ÏÄãÃÇµÄ¹·ÍÈ£¡
¶Ô²»Æğ£¬Ë×¼ÒµÜ×Ó²»µÃÈëËÂĞŞĞĞ
 */
void init()
{
...
int close_gate()
{
    ...
    if(objectp(room))
    {
        ...
        if (objectp(present("qingguan", room)))
            message("vision", "Çå¹ÛÉÏÇ°°Ñ´óÃÅ¹ØÁËÆğÀ´¡£\n", room);
        else
...
int do_knock(string arg)
{
    ...
    if(objectp(room))
    {
        ...
        message_vision("$NÇáÇáµØÇÃÁËÇÃÃÅ£¬Ö»ÌıÖ¨µØÒ»Éù£¬"
            "Ò»Î»×³ÄêÉ®ÈËÓ¦Éù´ò¿ª´óÃÅ£¬\n"
...
/*
        ...
        {
            return notify_fail("×³ÄêÉ®ÈËËµµÀ£º¶Ô²»Æğ£¬Ë×¼ÒµÜ×Ó²»µÃÈëËÂĞŞĞĞ¡£\n");
        }
*/
        ...
        write("×³ÄêÉ®ÈË³ÁÏÂÁ³À´£¬ËµµÀ£º½äÂÉÔºÖ÷³ÖĞş¼Å´óÊ¦ÇëÊ¦ĞÖ\n"
                "»ğËÙÈ¥½äÂÉÔº³ÂÊö´ËĞĞ¹ı·¸¡£\n");
		return 1;
        }
    }
    ...
    if (me->query("shen") >= 0)
    {
        ...
        {
            return notify_fail("×³ÄêÉ®ÈËËµµÀ£ºÕâÎ»Å®Ê©Ö÷»¹ÊÇÇë»Ø°Õ£¬"
                "±¾ËÂ´Ó²»½Ó´ıÅ®¿Í¡£\n");
        }
        else
        {
