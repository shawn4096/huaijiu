...
void create()
{
    ...
    set("chat_chance", 3);
    set("chat_msg", ({
        "缘根得意洋洋的说道：就是达摩院，罗汉堂的首座犯了戒，只要是罚到菜园子，我一样要问个明白！\n",
        }) );
...
int ask_job()
{
    ...
    message_vision(HIC"缘根和尚恶狠狠地对$N说的道：“你每天挑一百担粪水浇菜，只消少了\n"
    ...
    if( random(30)<1 )
    {
        message_vision(HIC"缘根骂道：“贼和尚，瞧不出你小小年纪，居然如此胆大妄为，什么\n"
                  +"戒律都去犯上一犯。今日不重重惩罚，如何出得我心中恶气？”折下\n"
                  +"一根树枝，没头没脑的便向$N头上抽来。\n"NOR,me);
        message_vision(HIC"$N不敢躲闪，让他抽打，片刻之间，便给打得满头满脸都是鲜血。\n"NOR,me);
