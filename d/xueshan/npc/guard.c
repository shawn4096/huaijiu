...
void create()
{
        ...
        this_object()->start_call_out( (: call_other, this_object(), "display", this_object() :), 5);
...
int accept_fight(object ob)
{
        ...
        if(( ob->query("id") == me->query("target") && random(10) > 7 && !me->query("xs/accept_fight"))
