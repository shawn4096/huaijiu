...
void do_ready(object me, object ob)
{
        message_vision(HIW"\n火势渐渐大了起来，一股浓重的草药味道扑鼻而来。应该熬药了。\n"NOR, ob);
        ob->start_busy(2);
        remove_call_out("do_confirm");
        call_out("do_confirm", 30+random(10), me, ob);
        return;
}

void do_confirm(object me, object ob)
{
        ...
        else 
        {
                ...
                call_out("do_failed", 7, me, ob);
        }
        return;
}

void do_failed(object me, object ob)
{
        object *obj;
        int i;
